package com.springactuator.api;
...
public class RestDemoApplication {
  ...
  //post mapping:localhost:9393/cloudvendor/
	//GetMapping:localhost:9393/cloudvendor/
	//PUTMapping:localhost:9393/cloudvendor/
	//DeleteMapping:localhost:9393/cloudvendor/5
	@Bean
